...
<body class="login-bg">
  ...
  <div class="auth-card">
    ...
    <form id="loginForm">
      <!-- Email Input -->
      <div class="mb-3">
        <label class="form-label font-weight-600 text-uppercase text-muted" style="font-size: 0.75rem; letter-spacing: 0.05em;">WORK EMAIL</label>
        <div class="position-relative">
          <i class="fa-regular fa-envelope position-absolute text-muted" style="left: 1rem; top: 50%; transform: translateY(-50%);"></i>
          <input type="email" class="form-control form-control-pp ps-5" id="email" placeholder="admin@university.edu" value="admin@college.edu" required>
        </div>
      </div>
      ...
      <div class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-1">
          <label class="form-label font-weight-600 text-uppercase text-muted mb-0" style="font-size: 0.75rem; letter-spacing: 0.05em;">PASSWORD</label>
        ...
        <div class="position-relative">
          ...
          <input type="password" class="form-control form-control-pp ps-5 pe-5" id="password" placeholder="••••••••••••" value="admin123" required>
      ...
      try {
        ...
        const fallbackStore = await fetch('session_store.php', {
          ...
          body: JSON.stringify({
            ...
            user: { name: 'Admin User', role: 'admin', email: document.getElementById('email').value }
          }),
        });
        if (fallbackStore.ok) {
          window.location.href = 'dashboard.php';
