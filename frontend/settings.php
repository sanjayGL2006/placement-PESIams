    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-md-9">
        <div class="tab-content" id="v-pills-tabContent">
          ...
          <div class="tab-pane fade show active" id="panel-profile" role="tabpanel">
            <div class="pp-card">
              ...
              <div class="d-flex align-items-center gap-4 mb-4">
                ...
                <div>
                  <h6 class="font-weight-700 mb-1"><?php echo htmlspecialchars($_SESSION['user']['name'] ?? 'Admin User'); ?></h6>
              ...
              <div class="row g-3">
                <div class="col-12 col-md-6">
                  <label class="form-label font-weight-600 text-muted small">DISPLAY NAME</label>
                  <input type="text" class="form-control form-control-pp" value="<?php echo htmlspecialchars($_SESSION['user']['name'] ?? 'Admin User'); ?>">
                </div>

                <div class="col-12 col-md-6">
                  <label class="form-label font-weight-600 text-muted small">EMAIL ADDRESS</label>
                  <input type="email" class="form-control form-control-pp" value="<?php echo htmlspecialchars($_SESSION['user']['email'] ?? 'admin@university.edu'); ?>">
                </div>

                <div class="col-12">
                  <label class="form-label font-weight-600 text-muted small">BIO</label>
                  <textarea class="form-control form-control-pp" rows="4" placeholder="Enter short bio or administrative scope...">Managing placement statistics, corporate partnerships, and campus recruitment drives for session 2023-2024.</textarea>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- 3. Notification Hub Panel -->
          <div class="tab-pane fade" id="panel-notifications" role="tabpanel">
            <div class="pp-card">
              <h5 class="h6 font-weight-800 text-dark mb-4 pb-2 border-bottom">Notification Hub</h5>
              ...
              <div class="d-flex flex-column gap-3">
                <div class="d-flex justify-content-between align-items-center pb-3 border-bottom">
                  ...
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="switchEmailDigest" checked style="width: 44px; height: 24px;">
                  </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center pb-3 border-bottom">
                  ...
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="switchSmsAlerts" style="width: 44px; height: 24px;">
                  </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="switchPush" checked style="width: 44px; height: 24px;">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="tab-pane fade" id="panel-trash" role="tabpanel">
            <div class="pp-card mb-4">
              <h5 class="h6 font-weight-800 text-dark mb-2 pb-2 border-bottom">System Soft Reset</h5>
              <p class="text-muted small mb-4">Temporarily wipe system records. Reset data will be safely moved to the Recycle Bin for potential restoration.</p>
              ...
              <div class="d-flex flex-wrap gap-3">
                ...
                <button class="btn btn-danger py-2 px-3 border-0 bg-danger text-white font-weight-600 rounded-3" style="background-color: var(--pp-danger-dot) !important;" onclick="confirmReset('all')">
                  <i class="fa-solid fa-triangle-exclamation me-1"></i> Delete All Data (Students & Companies)
                </button>
              </div>
            </div>
