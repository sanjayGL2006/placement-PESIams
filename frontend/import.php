    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-12 col-lg-8">
        <div class="dropzone-box" id="dropzone">
          ...
          <input type="file" id="fileInput" class="d-none" accept=".xlsx,.xls,.csv,.docx,.pdf">
  ...
  <script>
    ...
    function renderPreview() {
      ...
      document.getElementById('previewBody').innerHTML = previewData.rows.map((r, i) => {
        return `<tr>
          <td>
            <select class="form-select-pp py-1 small" onchange="previewData.rows[${i}].action=this.value">
